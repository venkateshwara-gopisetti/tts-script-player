...
Download tts-player.html
Open it in Chrome, Edge, or any browser with Web Speech API support
Add lines manually, or click ★ Load Demo to see a sample Steve Jobs script with timestamps
Hit ▶ on any card to speak it, or use ▶ Run Timeline to play scheduled lines automatically
...
Browser Support
BrowserStatusChrome / Edge (desktop)✅ Full support, including Neural voicesFirefox✅ Basic support (limited voice selection)Safari✅ Basic supportMobile browsers⚠️ Partial
Audio Routing (for streamers / recorders)
Install VB-Audio CABLE, set your browser output to CABLE Input, and select CABLE Output as mic in your recording app.
License
